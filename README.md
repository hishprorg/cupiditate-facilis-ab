# @hishprorg/cupiditate-facilis-ab

[![NPM Package Version](https://img.shields.io/npm/v/@hishprorg/cupiditate-facilis-ab)](https://www.npmjs.com/package/@hishprorg/cupiditate-facilis-ab)
[![Build Status](https://github.com/hishprorg/cupiditate-facilis-ab/workflows/CI/badge.svg)](https://github.com/hishprorg/cupiditate-facilis-ab/actions?query=workflow%3ACI)
...
```
npm i @hishprorg/cupiditate-facilis-ab
```
...
const SonicBoom = require('@hishprorg/cupiditate-facilis-ab')
...
* `retryEAGAIN(err, writeBufferLen, remainingBufferLen)`: a function that will be called when @hishprorg/cupiditate-facilis-ab
    write/writeSync/flushSync encounters a EAGAIN or EBUSY error. If the return value is
    true @hishprorg/cupiditate-facilis-ab will retry the operation, otherwise it will bubble the
    error. `err` is the error that caused this function to be called,
    `writeBufferLen` is the length of the buffer @hishprorg/cupiditate-facilis-ab tried to write, and
    `remainingBufferLen` is the length of the remaining buffer @hishprorg/cupiditate-facilis-ab didn't try to write.
